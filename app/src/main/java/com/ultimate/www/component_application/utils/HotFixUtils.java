 ...
 * @author 李宝
 * @date 2019/12/4
 * @Describe 核心类 将我们修复bug的dex文件替换掉原来的dex文件
 */
public class HotFixUtils {

    private static final String TAG = "hotDixTag";
    ...
    public void doHotFix(Context context) throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        // 补丁存放目录 /storage/emulated/0/Android/data/com.ultimate.www.myapplication/files/patch
        ...
        //TODO 生产不需要这个提示
        ToastUtil.show(context,"Bug修复完成");
    }
    ...
    private String getPatchDexPath(File[] listFiles) {
        ...
        for (int i = 0; i < listFiles.length; i++) {// 遍历查找文件中.dex .jar .apk .zip结尾的文件
            ...
            if (file.getName().endsWith(DEX_SUFFIX)
                ...
                if (i != 0 && i != (listFiles.length - 1)) {
                    sb.append(File.pathSeparator);// 多个dex路径 添加默认的:分隔符
                }
